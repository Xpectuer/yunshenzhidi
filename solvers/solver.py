...
def test4():
    ...
    k1 = clue.create_kernel((HERMITS, (0,0)),
                            (RIVER, (1,0)))
    k2 = clue.create_kernel((HERMITS, (0,0)),
                            (VILLIAGE, (1,0)))
    ...
    k4 = clue.create_kernel((FOREST, (0,0)),
                            (HERMITS, (0,1)))
    ...
    k_bird = clue.create_kernel((PLAINS, (0,0)),
                                 (RIVER,(0,1)),
                                 (PLAINS,(1,0)),
                                 (FOREST,(1,1)))
    ...
    solve(budgets, [hclue,hclue1,cclue])
